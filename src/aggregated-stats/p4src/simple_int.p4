...
control MyIngress(inout headers hdr,
    ...
    register<bit<32>>(1) total_qdepths;
    ...
    apply {
        ...
        if (hdr.ipv4.isValid()){
            ...
            total_qdepths.read(old_qdepths, 0);
            total_packets.read(old_packets, 0);

            total_qdepths.write(0, old_qdepths + qdepth32);
            total_packets.write(0, old_packets + 1);
...
control MyEgress(inout headers hdr,
    ...
    register<bit<32>>(1) total_deq_qdepths;
    ...
    apply {
        ...
        bit<32> dqdepth32 = (bit<32>) standard_metadata.deq_qdepth;
        bit<32> old_dq;

        total_deq_qdepths.read(old_dq, 0);
        total_deq_qdepths.write(0, old_dq + dqdepth32);
        }
